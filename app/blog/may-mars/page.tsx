  ...
  return (
    <main className="pt-10 flex min-h-screen flex-col items-center justify-between bg-#0F151F" style={{ backgroundColor: "#0F151F" }}>
      ...
      <div className="blog-layout">
        <div className="body">
          <div className="h1-simple">May MARS Recap!</div>
          <div className="side-min">
            <div className="h2-simple">Written by: </div>
            <div className="h3-simple">- May 31st 2025</div>
          </div>
          <img
          ...
          <p className='blog-paragraph'>
            So this saturday, May 31st, we hosted our first MARS workshop!
            If you don't know, MARS stands for Milpitas Applied Robotics & Science.
            We hosted 3 classes, and taught over 60 elementary schoolers!
          </p>
